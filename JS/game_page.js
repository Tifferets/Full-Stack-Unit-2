...
const fallingBallCard = document.getElementById("falling-ball");
...
// Redirect to the falling ball page when the card is clicked
fallingBallCard.addEventListener("click", () => {
  console.log("pressed");
  window.location.href = "falling_ball.html"; 
});